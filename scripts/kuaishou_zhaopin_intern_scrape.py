#!/usr/bin/env python3
"""
任务10+12：快手招聘实习岗位抓取与筛选
来源：zhaopin.kuaishou.cn
  positionNatureCode=C002（实习）, positionCategoryCode=J0005（产品）
"""
...
RAW_FILE  = os.path.join(OUT_DIR, "kuaishou_zhaopin_intern_raw.json")
OUT_FILE  = os.path.join(OUT_DIR, "kuaishou_zhaopin_intern_jobs.json")
EXCL_FILE = os.path.join(OUT_DIR, "kuaishou_zhaopin_intern_excluded.json")
...
DETAIL_TMPL = "https://zhaopin.kuaishou.cn/recruit/e/#/official/trainee/?jobId={job_id}"
...
def load_cookie() -> str:
    ...
    if os.path.exists(probe) and (time.time() - os.path.getmtime(probe)) < 3600:
        ...
        ck = d.get("zhaopin_trainee", {}).get("cookie_str", "")
        if ck:
...
def fetch_all(cookie: str) -> list:
    ...
    with sync_playwright() as p:
        ...
        while True:
            ...
            nav_url = (
                f"https://zhaopin.kuaishou.cn/recruit/e/#/official/trainee/"
                f"?workLocationCode=domestic&positionCategoryCode=J0005&pageNum={page_num}"
            )
...
# Stage3：排除无AI信号的通用PM岗，回捞 28718/30554（推荐/搜推策略）
STAGE3_EXCL: set = {
    "28611","15115","28071","16180","29954","30277","28556","30665","30620",
    "30658","30618","30457","20709","22963","30627","20926","30613","28765",
    "30105","30506","26247","30178","27478","20209","28674","30117","30101",
    "29991","28283","29899","29856","27921","29821","28516","27091","26976",
    "29095","29303","21252","29632","28193","27310","29492","26028","23890",
    "23158","17660","25394","26999","29009","29007","28918","28764","26027",
    "28575","3135","20073","28492","27831","27480","21834","27792","27390",
    "27493","27709","19059","25995","26468","26330","28210","26021","26600",
    "27481","26593","27367","27503","27606","27122","23396","27000","26731",
    "25178","26109","23202","24334","25137","25138","25136","9339","20914",
    "16249","20960","20256","21108","19055",
}
...
def main():
    print("="*60, flush=True)
    print("[任务10+12] 快手招聘实习", flush=True)
    cookie = load_cookie()
